...
int main()
{
	...
	Renderer worldRenderer(vertices.getVertices(), sizeof(float) * vertices.getVerticesSize());
	...
	Renderer waterRenderer(water.getVertices(), sizeof(float) * water.getVerticesSize());
